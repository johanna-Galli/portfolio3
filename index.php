                ...
                <div class="container80">
                    <div class="row">
                        <div class="col-sm">
                            ...
                            <p>
                                Je m'appelles Johanna, j'ai 23 ans et je suis actuellement en formation developpeuse web / web mobile à l'acces Code School Mulhouse.
                            </p>
                            <h5>
                            ...
                            <p>
                                En 2015 j'ai effectué un service civique dans une web radio à mulhouse (radio Antares). Ensuite dans le cadre de mon BTS Audiovisuel, j'étais 2 ans en alternance à France 3 Alsace (Strasbourg). Par la suite j'ai travaillée comme intermittente du spectacle en tant que technicienne vidéo sur plusieures antennes de France 3 Régions (Dijon, Nancy, Clermont-Ferrand, Besançon) mais aussi à DisneyLand Paris en régie pour un spectacle.
                            </p>
                        </div>
                        <div class="col-sm">
                        ...
                        <div class="col-sm">
                            ...
                            <p>
                                Membre active en tant que trésorière adjointe, responsable maquillage et musicienne de l'association <a href="https://www.lustige-klique.com/" target="_blank">La Lustige Klique de Riedisheim</a>.
                            </p>
                            <p>
        ...
        <section id="projects">
            <div class="contain">
                ...
                <div class="containerProjects">
                    <!--ALLO JATI-->
                    <a href="https://johannag.promo-36.codeur.online/allo_jati/" target="_blank" class="col-sm linkProject p-0 m-4">
                    ...
                    <!--YES TRANSFERT-->
                    <a href="https://johannag.promo-36.codeur.online/YesTransfert/" target="_blank" class="col-sm linkProject p-0 m-4">
