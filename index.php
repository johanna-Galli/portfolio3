...
<body>
    ...
    <header id="header">
        <nav class="topnav" id="myTopnav">
            <a href="#me" class="btn">Moi</a>
            <a href="#skills" class="btn">Compétences</a>
            ...
            <div id="me">
                ...
                <div class="meText">
                    ...
                    <a href="https://github.com/johanna-Galli" target="_blank">
                        <img src="asset/img/github.png" alt="logo GitHub" class="myLogo">
                    </a>
            ...
            <div class="container80">
                <div class="row">
                    <div class="col-sm">
                        ...
                        <p>
                            J'ai effectuée mon BTS audiovisuel en alternance a France 3 Alsace (Strasbourg). Par la suite j'ai travaillée comme intermittente du spectacle en tant que technicienne vidéo sur plusieures antennes de France 3 Régions (Dijon, Nancy, Clermont-Ferrand, Besançon) mais aussi à DisneyLand Paris dans la régie d'un spectacle.
                        </p>
                    </div>
                    <div class="col-sm">
